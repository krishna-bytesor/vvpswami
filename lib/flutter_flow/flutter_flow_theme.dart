...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryText = const Color(0xFFFF6260);
  ...
  late Color backgroundColor = Color(0xFFF8ECDD);
  late Color customColor1 = Color(0xFF4EF76A);
  late Color bittersweet = Color(0xFFFF6160);
  late Color oldLace = Color(0xFFFEF8EB);
  late Color gray = Color(0xFF7D7D7D);
  late Color davysGray = Color(0xFF4F4F4F);
  late Color lightCoral = Color(0xFFF16E6F);
  late Color backGrey = Color(0xFF436073);
}
